							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_product" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-product="<?php echo $row['product_id'] ?>" data-category_id="<?php echo $row['category_id'] ?>"data-mfg="<?php echo $row['mfg_date'] ?>" data-exp="<?php echo $row['exp_date'] ?>" data-description="<?php echo $row['description'] ?>" data-price="<?php echo $row['price'] ?>" >Edit</button>
